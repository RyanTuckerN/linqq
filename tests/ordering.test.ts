import linq, { OrderedEnumerable, EnumerableBase, IEnumerable } from "../src";
...
test(" *** Sorting ***", () => {
  ...
  expect(orderedAsc).toBeInstanceOf(OrderedEnumerable);
  ...
  expect(orderedDesc).toBeInstanceOf(OrderedEnumerable);
